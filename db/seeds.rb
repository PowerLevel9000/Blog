...
User.create(name: 'Monsieur Julien Robert', photo: 'https://randomuser.me/api/portraits/men/77.jpg', email: 'julien.robert@example.com', password: 123456, bio: "Astrophysicist | Exploring the Cosmos | Passionate about the Universe | Science Communicator  Welcome to my cosmic journey! I'm [Your Name], an astrophysicist fascinated by the mysteries of the universe. Join me as we unravel the secrets of stars, galaxies, and everything in between. I'm here to share captivating insights, cutting-edge research, and mind-blowing discoveries. Let's explore the cosmos together and ignite a love for space. || Astrophysicist || CosmicExploration || ScienceCommunication")
User.create(name: 'Neusita Cavalcanti', photo: 'https://randomuser.me/api/portraits/women/37.jpg', email: 'neusita.cavalcanti@example.com', password: 123456, bio: "I'm a passionate software engineer, dedicated to crafting elegant and efficient solutions to complex problems. With a strong background in programming and a love for technology, I thrive on turning ideas into reality through clean code and innovative software development. Follow along as I share my coding journey, insights, and tips for building robust and scalable software. Let's shape the digital world together. SoftwareEngineer, CodeCrafting, nnovationDriven")
User.create(name: 'Helmi Tervo', photo: 'https://randomuser.me/api/portraits/women/58.jpg', email: 'helmi.tervo@example.com', password: 123456, bio: "I'm a wanderer at heart, exploring the world one adventure at a time. Join me as I share my travel tales, breathtaking landscapes, and unforgettable experiences. Let's embark on this journey together and discover the beauty that lies beyond the horizon. | Traveler | Wanderlust | AdventureAwaits")
User.create(name: 'Asher Turner', photo: 'https://randomuser.me/api/portraits/men/5.jpg', email: 'asher.turner@example.com', password: 123456, bio: "Passionate architect dedicated to shaping spaces that inspire and transform. With an unwavering commitment to design excellence, I strive to create environments that uplift and enhance the human experience. Follow along as I share my architectural journey, innovative ideas, and love for sustainable design. Together, let's build a better future. ||PassionateArchitect || DesignExcellence || Sustainability")
User.create(name: 'Rogelio Castellanos', photo: 'https://randomuser.me/api/portraits/men/95.jpg', email: 'rogelio.castellanos@example.com', password: 123456, bio: "no bio")
User.create(name: 'Adarsh Pathak', photo: 'https://randomuser.me/api/portraits/men/75.jpg', email: 'adi8090808766@gmail.com', password: 123456, bio: "Full-Stack Developer || React || ROR || Ruby || HTML || CSS || JS || I am sayian from planet Full-stack each coding fight make me stronger than before || 5 🌟 Hacker Rank")

Post.create(title: 'Sustainable Architecture', text: "# The Evolution of Sustainable Architecture
...
", author_id:1)
Post.create(title: 'Black Holes', text: "# Exploring Black Holes: Gateways to the Unknown
...
", author_id:2)
Post.create(title: 'Minimalist Architecture', text: "# Exploring Minimalist Architecture: Less is More
...
As we move forward, minimalist architecture continues to evolve and adapt to contemporary needs. We examine emerging trends and innovative applications of minimalist design, such as modular construction, sustainable materials, and the integration of smart technologies.
...
", author_id: 1)
Post.create(title: 'Understanding Stellar Evolution', text: "# The Dance of Stars: Understanding Stellar Evolution
...
", author_id: 2)
Post.create(title: 'Beyond Our Solar System', text: "# Beyond Our Solar System: Exploring Exoplanets
...
", author_id: 2)
Post.create(title: ' World of Cybersecurity', text: "# The Fascinating World of Cybersecurity
...
", author_id: 3)
Post.create(title: 'The Power of Algorithms', text: "# The Power of Algorithms
...
", author_id: 3)
Post.create(title: 'Data Science and Big Data', text: "# The Rise of Data Science and Big Data
...
", author_id: 3)
Post.create(title: 'Quantum Computing', text: "# The Future of Computing: Quantum Computing
...
In this post, we embark on an exciting journey into the quantum realm. We'll explore the mind-boggling principles of superposition and entanglement, which form the foundation of quantum computing. We'll discuss quantum gates, quantum algorithms, and the potential applications of quantum computing in fields like cryptography, optimization, and scientific simulations.
...
", author_id: 3)
Post.create(title: 'Artificial Intelligence and Machine Learning', text: "# Exploring Artificial Intelligence and Machine Learning
...
The applications of AI and ML are far-reaching. In healthcare, they contribute to early disease detection and personalized medicine. In finance, they enhance fraud detection and algorithmic trading. In autonomous systems, they power self-driving cars and intelligent robots. And these are just a few examples.
...
", author_id: 3)
Post.create(title: 'Software Engineering', text: "# The Art of Software Engineering
...
Comment.create(author_id: 2, text: "As an astrophysicist, I find it fascinating to draw parallels between the vastness of the universe and the intricacies of architecture. Both fields explore the fundamental laws that govern our existence, whether it's the forces shaping galaxies or the principles guiding the design of buildings. The evolution of sustainable architecture resonates with our collective responsibility to preserve and sustain our planet, just as astrophysics reminds us of our place in the cosmos. It's incredible to witness how architectural innovation can blend functionality, aesthetics, and sustainability, creating harmonious spaces that inspire us to reach for the stars. ", post_id: 2)
Comment.create(author_id: 3, text: "Architecture meets sustainability for a greener future! #SustainableDesign ", post_id: 1)
Comment.create(author_id: 3, text: "Discover the beauty and tranquility of minimalist architecture! #MinimalistDesign #SimplicityAtItsBest", post_id: 2)
Comment.create(author_id: 3, text: "Embark on an incredible journey to distant exoplanets and imagine the possibilities! #ExoplanetExploration #VastCosmicFrontiers", post_id: 5)
Comment.create(author_id: 3, text: "Delve into the captivating dance of stars and unravel the secrets of their evolution! #StellarJourney #CelestialBeauty", post_id: 4)
Comment.create(author_id: 3, text: "Mind-bending journey into the mysterious realm of black holes! #CosmicMysteries #BlackHoleExploration", post_id: 3)
Comment.create(author_id: 3, text: "Stellar evolution unfolds like a mesmerizing cosmic ballet! #StellarJourney #CelestialDance", post_id: 4)
Comment.create(author_id: 4, text: "Wow Great Article I learnt something new today", post_id: 2)
Comment.create(author_id: 4, text: "I am just mesmerised the level of your feelings and article towards nature ", post_id: 1)
Comment.create(author_id: 4, text: "These things are bouncers for me 😂😂😂 I never went beyond my city yet ", post_id: 4)
Comment.create(author_id: 4, text: "I always fear what will happen if our entire solar system went into Black hole 😨😨😨😨😱😱", post_id: 3)
Comment.create(author_id: 4, text: "Again i am not going anywhere lot of responsibility 🥲🥲🥲 btw Iove your articles", post_id: 5)
Comment.create(author_id: 4, text: "Robot Stuffs I don't care lol 😂😂😂😂😁💕", post_id: 11)
Comment.create(author_id: 4, text: "I always wonder how Instagram know what i am thinking ", post_id: 10)
Comment.create(author_id: 4, text: "I appreciate your effort to teach me but I didn't understand  may be I am dumb ", post_id: 9)
Comment.create(author_id: 5, text: "hi Julien i like your comment", post_id: 2)
Comment.create(author_id: 5, text: "Asher Great article man we should focus on Minimalist Architecture with suitability as well", post_id: 2)
Comment.create(author_id: 5, text: "btw can you msg me private i need a contract for you
", post_id: 2)
...
Like.create(author_id: 1, post_id: 1)
Like.create(author_id: 2, post_id: 3)
Like.create(author_id: 2, post_id: 3)
Like.create(author_id: 2, post_id: 3)
Like.create(author_id: 2, post_id: 3)
Like.create(author_id: 2, post_id: 4)
Like.create(author_id: 2, post_id: 4)
Like.create(author_id: 2, post_id: 4)
Like.create(author_id: 2, post_id: 4)
Like.create(author_id: 2, post_id: 4)
Like.create(author_id: 2, post_id: 5)
Like.create(author_id: 2, post_id: 5)
Like.create(author_id: 3, post_id: 1)
Like.create(author_id: 3, post_id: 1)
Like.create(author_id: 3, post_id: 2)
Like.create(author_id: 3, post_id: 11)
Like.create(author_id: 3, post_id: 11)
Like.create(author_id: 3, post_id: 11)
Like.create(author_id: 3, post_id: 11)
Like.create(author_id: 3, post_id: 10)
Like.create(author_id: 3, post_id: 10)
Like.create(author_id: 3, post_id: 10)
Like.create(author_id: 3, post_id: 10)
Like.create(author_id: 3, post_id: 10)
Like.create(author_id: 3, post_id: 9)
Like.create(author_id: 3, post_id: 9)
Like.create(author_id: 3, post_id: 9)
Like.create(author_id: 3, post_id: 9)
Like.create(author_id: 3, post_id: 7)
Like.create(author_id: 3, post_id: 7)
Like.create(author_id: 3, post_id: 7)
Like.create(author_id: 3, post_id: 8)
Like.create(author_id: 3, post_id: 8)
Like.create(author_id: 3, post_id: 8)
Like.create(author_id: 3, post_id: 6)
Like.create(author_id: 3, post_id: 6)
Like.create(author_id: 3, post_id: 6)
Like.create(author_id: 4, post_id: 9)